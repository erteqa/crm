...
var player = (function () {
    var play = document.getElementById("play"), fullscreen = document.getElementById("expand"),
        playlist = document.getElementById("playlist"), audioVolume = document.getElementById("audioVolume"),
        progress = document.getElementById('progress'), start = document.getElementById('start'),
        finish = document.getElementById('finish'), preload = document.getElementById('preload');
    var mediaPlayer, currentTrack = "0", videos, videoNodes;
    ...
    fullscreen.addEventListener("click", () => {
        if (mediaPlayer.requestFullscreen) mediaPlayer.requestFullscreen(); else if (mediaPlayer.webkitRequestFullscreen) mediaPlayer.webkitRequestFullscreen(); else if (mediaPlayer.mozRequestFullScreen) mediaPlayer.mozRequestFullScreen(); else if (mediaPlayer.msRequestFullscreen) mediaPlayer.msRequestFullscreen();
    });
    playlist.addEventListener("click", function (e) {
        var target = e.target;
        if (target.id != "playlist") {
            var id = target.closest(".video").id, el = target.closest(".video");
    ...
    function handleProgress(e) {
        var minutes = Math.floor(mediaPlayer.currentTime / 60),
            seconds = Math.floor(mediaPlayer.currentTime - minutes * 60), x = minutes < 10 ? "0" + minutes : minutes,
    ...
    function create(itemList) {
        var div = document.createElement("div"), imageContainer = document.createElement("div"),
            videoIformation = document.createElement("idv"), img = document.createElement("img"),
            title = document.createElement('p'), duration = document.createElement("span");
    ...
    function loadList(playlist) {
        var domPlayList = document.getElementById('playlist'), fragmentList = document.createDocumentFragment();
