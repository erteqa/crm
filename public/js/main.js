...
var player = (function() {//Namespace todo lo que esta aqui dentro es privado
    ...
    playlist.addEventListener("click", function(e) {
        ...
        if (target.id != "playlist") {
            ...
            // alert(currentTrack.toString());
            higlight(id, currentTrack.toString());
            videoNodes = document.querySelectorAll('.video');
           // alert(videos[id].source);
            $.ajax({
                type:'GET',
                url:'/Customer/UserFile/crdeurl',
                data:{source: videos[id].source},
    ...
    // loadList('<?php echo json_encode($phpArray); ?>');
