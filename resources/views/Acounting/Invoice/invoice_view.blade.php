...
@section('head')
    {{--{!! Html::style("assets/myjs/datepicker.min.js") !!}--}}
    {{--{!! Html::style("assets/myjs/summernote-bs4.min.js") !!}--}}
    {{--{!! Html::style("assets/myjs/select2.min.js") !!}--}}
    {{--{!! Html::style("Admin/vendor/font-awesome/css/font-awesome.min.css") !!}--}}

    {{--{!! Html::script("InvoiceStyle/assets/myjs/datepicker.min.js!!}--}}
    {{--{!! Html::script("InvoiceStyle/assets/myjs/summernote-bs4.min.js") !!}--}}
    {{--{!! Html::script("InvoiceStyle/assets/myjs/select2.min.js") !!}--}}
                                ...
                                <div class="inner-cmp-pnl">
                                    <div class="form-group row">
                                        <div class="col-sm-12"><h3
                                                    class="title">{{ __('lang.Invoice_Properties')}} </h3>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6"><label for="invocieno"
                                                                     class="caption">{{__('lang.Invoice_Number')}}</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6"><label for="invociedate"
                                                                     class="caption">{{__('lang.Invoice_Date')}}</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><span class="icon-calendar4"
                                                                                     aria-hidden="true"></span></div>
                                                <input type="text" id="datepicker" value="{{$invoicedate}}"
                                        ...
                                        <div class="col-sm-6"><label for="invocieduedate"
                                                                     class="caption">{{__('lang.Invoice_Due_Date')}}</label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><span class="icon-calendar-o"
                                                                                     aria-hidden="true"></span></div>
                                                <input type="text" id="datepicker" value="{{$invocieduedate}}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6">
                                            <label for="taxformat"
                                                   class="caption">{{__('lang.taxformat')}}</label>
                                            <select class="form-control" name="taxformat"
                                                    onchange="changeTaxFormat(this.value)"
                                                    id="taxformat">
                                                <option selected value="off">{{__('lang.Off')}}</option>
                                                <option value="on">{{__('lang.On')}}</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="discountFormat"
                                                       class="caption">{{__('lang.discountFormat')}} </label>
                                                <select class="form-control" onchange="changeDiscountFormat(this.value)"
                                                        id="discountFormat">
                                                    <option value="%">{{__('lang.%Discount').''.__('lang.After_TAX') }} </option>
                                                    <option value="flat">{{__('lang.Flat_Discount').' '.__('lang.After_TAX')  }}</option>
                                                    <option value="b_p">{{__('lang.%Discount').' '.__('lang.Before_TAX')  }}</option>
                                                    <option value="bflat">{{__('lang.Flat_Discount').' '.__('lang.Before_TAX')  }}</option>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <label for="toAddInfo"
                                                   class="caption">{{__('lang.Invoice_Note') }}</label>
                                ...
                                <div id="saman-row">
                                    <table class="table-responsive tfr my_stripe">
                                        ...
                                        <tr class="item_header">
                                            <th width="30%" class="text-center">{{__('lang.Item_Name') }}</th>
                                            <th width="8%" class="text-center">{{__('lang.Quantity') }}</th>
                                            <th width="10%" class="text-center">{{__('lang.Rate') }}</th>
                                            <th width="10%" class="text-center">{{__('lang.Tax(%)') }}</th>
                                            <th width="10%" class="text-center">{{__('lang.Tax') }}</th>
                                            <th width="7%" class="text-center">{{__('lang.Discount') }}</th>
                                            <th width="10%" class="text-center">
                                                {{__('lang.Amount') }}
                                                {{--({{$this->config->item('currency') }})--}}
                                            </th>
                                            <th width="5%" class="text-center">{{__('lang.Action') }}</th>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><input type="text" class="form-control text-center"
                                                       name="product_name[]"
                                                       placeholder="{{__('lang.Enter_Product_name') }}"
                                                       id='productname-0'>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="8"><textarea id="dpid-0" class="form-control"
                                                                      ...
                                                                      placeholder="{{__('lang.Enter_Product_description') }}"
                                        ...
                                        <tr class="sub_c" style="display: table-row;">
                                            <td colspan="6" align="right">
                                                <strong>{{__('lang.Total_Discount') }}</strong></td>
                                            <td align="left" colspan="2"><span
                                                        class="currenty lightMode"></span>
                                        ...
                                        <tr class="sub_c" style="display: table-row;">
                                            <td colspan="2"></td>
                                            <td colspan="4" align="right"><strong>{{__('lang.Grand_Total')}}
                                                    <span
                                        ...
                                        <tr>
                                            <td align="right" colspan="6"><input type="submit"
                                                                                 ...
                                                                                 value="{{__('lang.Generate_Invoice') }}"
                                                                                 id="submit-data"
