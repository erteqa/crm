                ...
                <div class="panel panel-primary">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="">
                                    <input  type="number" placeholder="{{__('lang.Enter_amount')}}"
                                            class="form-control" value="{{$payment->amount}}" name="amount" readonly required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <label>{{ __('lang.Custmer') }}</label>
                                    <div class="">
                                        <input  type="text" placeholder="{{__('lang.Enter_amount')}}"
                                                class="form-control" value="{{$payment->Customer->name}}"  readonly required>
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-8">
                            ...
                            <div class="">
                                <input  type="number" placeholder="{{__('lang.Enter_amount')}}"
                                        class="form-control" value="{{$payment->Invoice->tid}}" readonly required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 mb-1"><label
                            ...
                            <input  type="text" class="form-control"
                                    name="note" value="{{$payment->note}}" placeholder="Short note" readonly id="not"
                            ></div>
                    </div>
