...
@section('content')
    ...
    <div class="col-lg-10">
        <a class="btn btn-primary" style="margin-bottom: 10px"
           href="{{route('Lesson.Index',['id'=>$Coursid])}}">{{__('lang.Lessons_View') }}</a>
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="timeshow" placeholder="{{__('lang.timeshow') }}" class="form-control{{ $errors->has('timeshow') ? ' is-invalid' : '' }}"   value="{{ old('timeshow') }}"  >
                </div>
