<table >
    <tr >
        <td class="myco">
            <img  style="max-width:260px;" src="<?php echo e(public_path() . '/Images/logo.png'); ?>">
        </td>
        <td class="myw">
            <table class="top_sum">
                <tr>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Acounting/Invoice/header-print.blade.php */ ?>