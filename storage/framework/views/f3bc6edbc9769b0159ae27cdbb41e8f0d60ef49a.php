...
<div class="sign1"><img  width="160" height="50" border="0" alt="" src="<?php echo e(public_path() . '/Signature/'. \Illuminate\Support\Facades\Auth::user()->Signature); ?>"></div><div class="sign2">(<?php echo e($employee['name']); ?>)</div>
...
<?php /* C:\dd\crmlaraveltest\resources\views/Acounting/Invoice/view_print_rlt.blade.php */ ?>