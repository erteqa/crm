...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-lg-10">
        <a class="btn btn-primary" style="margin-bottom: 10px"
           href="<?php echo e(route('Lesson.Index',['id'=>$Coursid])); ?>"><?php echo e(__('lang.Lessons_View')); ?></a>
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="timeshow" placeholder="<?php echo e(__('lang.timeshow')); ?>" class="form-control<?php echo e($errors->has('timeshow') ? ' is-invalid' : ''); ?>"   value="<?php echo e(old('timeshow')); ?>"  >
                </div>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Academy/Lesson/Add_view.blade.php */ ?>