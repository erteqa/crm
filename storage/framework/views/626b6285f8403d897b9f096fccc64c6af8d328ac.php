<?php $__env->startSection('title'); ?>
    <?php echo e(__('lang.Make_Account')); ?>
    ...
    <form method="post">
        ...
        <div>
            <div class="panel panel-danger">
                <div class="panel-heading">
                    <label><?php echo e(__('lang.sales')); ?></label>
                </div>
                    <div id="saman-row_sales">
                        <table class="table-responsive tfr my_stripe">
                            <thead>
                            <tr class="item_header">
                                <th width="10%" class="text-center"> <?php echo e(__('lang.Invoice')); ?> </th>
                                <th width="7%" class="text-center"> <?php echo e(__('lang.Tax(%)')); ?> </th>
                                <th width="15%" class="text-center"><?php echo e(__('lang.Tax')); ?></th>
                                <th width="15%" class="text-center"> <?php echo e(__('lang.Amount')); ?> </th>
                                <th width="10%" class="text-center"> <?php echo e(__('lang.Action')); ?> </th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                            ...
                            <div class="panel-footer">
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    <td colspan="1">
                                        <strong><?php echo e(__('lang.Total_Invoice')); ?></strong></td>
                                    <td colspan="2"><span
                                                class="currenty lightMode"></span>
                                ...
                                <tr class="sub_c" style="display: table-row;">
                                    ...
                                    <td colspan="1"><strong><?php echo e(__('lang.Grand_Total')); ?>
        ...
        <div >
            <div class="panel panel-yellow">
                <div class="panel-heading">
                    <label><?php echo e(__('lang.Purchases')); ?></label>
                </div>
                <div >
        ...
        <div>
            <div class="panel panel-red">
                <div class="panel-heading">
                    <label><?php echo e(__('lang.result')); ?></label>
                </div>
                <div class="panel-body">
                    <tr class="sub_c" style="display: table-row;">
                        <td colspan="6" align="right">
                            <strong><?php echo e(__('lang.Tax')); ?></strong></td>
                    ...
                    <tr class="sub_c" style="display: table-row;">
                        <td colspan="6" align="right">
                            <strong><?php echo e(__('lang.Annual_profits')); ?></strong></td>
                        <td align="left" colspan="2"><span
                                    class="currenty lightMode"></span>
        ...
        <div >
            <div class="panel panel-green">
                <div class="panel-heading">
                    <label><?php echo e(__('lang.Expenses')); ?></label>
                </div>
                <div >
        ...
        <div class="col-lg-8 koko">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <label><?php echo e(__('lang.last_result')); ?></label>
                </div>
                <div class="panel-body">

                    <tr class="sub_c" style="display: table-row;">
                        <td colspan="6" align="right">
                            <strong><?php echo e(__('lang.Tax_last')); ?></strong></td>
                        <td align="left" colspan="2"><span
                                    class="currenty lightMode"></span>
                    ...
                    <tr class="sub_c" style="display: table-row;">
                        <td colspan="6" align="right">
                            <strong><?php echo e(__('lang.Annual_profits_last')); ?></strong></td>
                        <td align="left" colspan="2"><span
                                    class="currenty lightMode"></span>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Customer/Acounting/make_account_view.blade.php */ ?>