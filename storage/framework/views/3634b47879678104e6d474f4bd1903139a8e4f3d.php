        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <a class="btn btn-primary" style="margin-bottom: 10px"
                   href="<?php echo e(route('Cu.Ticket.Add')); ?>"><?php echo e(__('lang.Add_Ticket')); ?></a>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-danger"
                                   onclick="del('<?php echo e(route('Cu.Ticket.Delete',['id'=>$Ticket->id,'type'=>'A'])); ?>')"><?php echo e(__('Delete')); ?></a>
                                <a class="btn btn-warning"
                                   href="<?php echo e(route('Cu.Ticket.View',['id'=>$Ticket->id,'type'=>'A'])); ?>"><?php echo e(__('View')); ?></a>
                            </td>
                        </tr>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Customer/Ticket/Index_view.blade.php */ ?>