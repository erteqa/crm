                        ...
                        <select class="js-example-basic-single form-control" name="department_id">
                            ...
                            <?php if(!is_null($departments)): ?>
                                <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!is_null($group->Department)): ?>
                                        <option <?php echo e($department->id==$group->Department->id?'selected="selected"':''); ?>  value="<?php echo e($department->id); ?>"><?php echo e($department->name); ?></option>
                                    <?php else: ?>
...
<?php /* C:\dd\crmlaraveltest\resources\views/Crm/Group/Update_view.blade.php */ ?>