                            ...
                            <div class="col-xs-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="SMS" name="mobile"
                                           value="<?php echo e($invoice->Customer->phone); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 mb-1">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php echo e($invoice->Customer->name); ?>"></div>
                        </div>

                        <div class="row">
                            <div class="col-xs-12 mb-1"><label
                                        for="shortnote"><?php echo e(__('lang.Message')); ?></label>
                                <textarea class="form-control ckeditor" name="text_message" id="sms_tem" title="Contents"
                                          rows="3"><?php echo e(__('lang.'.$Message)); ?></textarea></div>
                        </div>
...
<?php /* C:\dd\crmlaraveltest\resources\views/Acounting/Invoice/sendsms_view.blade.php */ ?>