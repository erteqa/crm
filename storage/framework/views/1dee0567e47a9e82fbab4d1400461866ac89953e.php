<?php $__env->startSection('title'); ?>
    <?php echo e(__('lang.Add_Employee')); ?>
                ...
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single form-control" name="department_id">
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\App\Http\Controllers\Admin\Department_cont::permision($department,'Add')|| $department->name =='Default'): ?>
                    ...
                    <select class="js-example-basic-single form-control" name="division_id">
                        ...
                        <?php if(!is_null($divisions)): ?>
                            <?php $__currentLoopData = $divisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $division): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(\App\Http\Controllers\Admin\Department_cont::permision($division,'Add')|| $division->name =='Default'): ?>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Crm/Employee/Add_view.blade.php */ ?>