                ...
                <div class="panel panel-primary">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <div class="">
                                    <input  type="number" placeholder="<?php echo e(__('lang.Enter_amount')); ?>"
                                            class="form-control" value="<?php echo e($payment->amount); ?>" name="amount" readonly required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <label><?php echo e(__('lang.Custmer')); ?></label>
                                    <div class="">
                                        <input  type="text" placeholder="<?php echo e(__('lang.Enter_amount')); ?>"
                                                class="form-control" value="<?php echo e($payment->Customer->name); ?>"  readonly required>
                                    </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-8">
                            ...
                            <div class="">
                                <input  type="number" placeholder="<?php echo e(__('lang.Enter_amount')); ?>"
                                        class="form-control" value="<?php echo e($payment->Invoice->tid); ?>" readonly required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 mb-1"><label
                            ...
                            <input  type="text" class="form-control"
                                    name="note" value="<?php echo e($payment->note); ?>" placeholder="Short note" readonly id="not"
                            ></div>
                    </div>
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/Acounting/Payment/View_view.blade.php */ ?>