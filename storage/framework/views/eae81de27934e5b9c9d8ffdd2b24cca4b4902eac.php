...
<br>
        ...
        <div  class="col-2">
            <label >
                <span style="font-weight: bold;font-size: larger"><?php echo e(__('التخصصات المطلوبة')); ?></span>
        ...
        <div  class="col-3">
            <label>
                 <span style="font-weight: bold;font-size: large"><?php echo e(__('صورة الكملك او جواز السفر')); ?></span>
                <input placeholder="الصورة" multiple="multiple" type="file" name="passpor" value="upload" tabindex="6" required>

            </label>
        </div>
        <div  class="col-3">
            <label>
                 <span style="font-weight: bold;font-size: large"><?php echo e(__('صورة شخصية')); ?></span>
                <input placeholder="الصورة" multiple="multiple" type="file" name="personal" value="upload" tabindex="6" required>
        ...
        <div  class="col-3">
            <label>
                <span style="color: red;">حقل اختياري </span> <span style="font-weight: bold;font-size: large"><?php echo e(__(' صورة كشف علامات الثانوية')); ?></span>
                <input placeholder="الصورة" multiple="multiple" type="file" name="cirtifcate" value="upload" tabindex="6" >
...
<?php /* H:\root\home\eritqaaacademy-001\www\crm\CRMV3\crmlaraveltest\resources\views/uni.blade.php */ ?>